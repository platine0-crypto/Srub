import{A as p,r as d,j as t,t as e,g as b}from"./index-CgzaBTtJ.js";import"./vendor-react-j2mp3VYR.js";const c={sectionTitle:"БАЗОВЫЕ КОНЦЕПЦИИ-ИДЕИ ДЛЯ ЛИНИИ СИБИРЬ",sectionDescription:"Ваш дом не обязан быть типовым. Используйте эти или любые другие идеи из сети как фундамент для творчества — мы адаптируем их под ваши запросы и реализуем в заводском качестве бизнес-класса.",badgeText:"КЛАССЫ: BUSINESS и COMFORT+",styles:{cardHeightDesktop:660,cardHeightMobile:520,borderRadius:40,gap:32,gapMobile:80,titleSize:36,subtitleSize:14,headerTitleSize:56,headerDescriptionSize:22,tabFontSizeDesktop:14,tabGapDesktop:40,titleSizeMobile:34,subtitleSizeMobile:15,headerTitleSizeMobile:36,headerDescriptionSizeMobile:20,tabFontSizeMobile:14,tabGapMobile:32,badgeFontSize:13,badgePaddingX:20,badgePaddingY:8,buttonHeight:72,buttonFontSize:18,buttonFontSizeMobile:18},items:[{title:"SPA-РЕЗИДЕНЦИИ",subtitle:"(Жилая SPA-усадьба для отдыха и жизни)",imageExterior:`${p}/images/vitrina/spa-ext_result.webp`,imageInterior:`${p}/images/vitrina/spa-inter_result.webp`,defaultMode:"exterior",href:"#spa",buttonText:"СМОТРЕТЬ SPA-ПРОЕКТЫ"},{title:"УСАДЬБЫ",subtitle:"(Капитальные резиденции для семьи и ПМЖ)",imageExterior:`${p}/images/vitrina/usadba-ext_result.webp`,imageInterior:`${p}/images/vitrina/usadba-inter_result.webp`,defaultMode:"interior",href:"#estates",buttonText:"СМОТРЕТЬ УСАДЬБЫ"},{title:"LOUNGE-ЗОНЫ",subtitle:"(Статусные локации для приема гостей)",imageExterior:`${p}/images/vitrina/lounge-ext_result.webp`,imageInterior:`${p}/images/vitrina/lounge-inter_result.webp`,defaultMode:"exterior",href:"#lounge",buttonText:"ОЦЕНИТЬ ЛАУНЖ-ЗОНЫ"}]},D=()=>{const $=d.useRef(null),u=d.useRef(null),v=d.useRef([]),[z,h]=d.useState(!1),[S,y]=d.useState(new Array(c.items.length).fill(!1)),[x,M]=d.useState(c.items.map(a=>a.defaultMode)),[j,N]=d.useState(new Array(c.items.length).fill(!1)),[k,E]=d.useState(new Array(c.items.length).fill(!1));d.useEffect(()=>{const a=window.innerWidth<=768,r=new IntersectionObserver(([s])=>{a||h(s.isIntersecting)},{threshold:.05,rootMargin:"0px 0px 100px 0px"}),n=new IntersectionObserver(s=>{a&&s.forEach(g=>{const o=Number(g.target.getAttribute("data-index"));y(m=>{const w=[...m];return w[o]=g.isIntersecting,w})})},{threshold:.1,rootMargin:"0px 0px 50px 0px"});u.current&&r.observe(u.current),v.current.forEach(s=>{s&&n.observe(s)});const l=setTimeout(()=>{if(u.current&&!a){const s=u.current.getBoundingClientRect();s.top<window.innerHeight&&s.bottom>0&&h(!0)}},100);return()=>{r.disconnect(),n.disconnect(),clearTimeout(l)}},[]);const I=(a,r)=>{const n=[...x];n[a]=r,M(n)},f=(a,r)=>{r==="exterior"?N(n=>{const l=[...n];return l[a]=!0,l}):E(n=>{const l=[...n];return l[a]=!0,l})},i=c.styles;return t.jsxs("section",{ref:$,className:"vitrina-section w-full flex flex-col items-center bg-[#0B1221] relative z-20",children:[t.jsx("div",{style:{maxWidth:e(b.layout.containerMaxWidth)},className:"w-full flex flex-col mb-[4rem] md:mb-[6rem] px-[20px] md:px-0",children:t.jsxs("div",{className:"flex flex-col w-full",children:[t.jsx("h2",{className:"vitrina-main-title font-black uppercase text-white mb-[1.5rem] md:whitespace-nowrap",children:c.sectionTitle.split(" ").map((a,r)=>t.jsxs("span",{className:a.includes("СИБИРЬ")?"gold-gradient":"",children:[a," "]},r))}),t.jsx("p",{className:"vitrina-description text-white/60 font-medium max-w-[64rem]",children:c.sectionDescription})]})}),t.jsx("div",{ref:u,style:{maxWidth:e(b.layout.containerMaxWidth)},className:`vitrina-grid-container w-full grid grid-cols-1 md:grid-cols-3 mx-auto px-[20px] md:px-0 transition-all duration-1000 ${z?"dt-grid-visible":"dt-grid-hidden"}`,children:c.items.map((a,r)=>{const n=x[r],l=S[r],s=j[r],g=k[r];return t.jsxs("div",{"data-index":r,ref:o=>{v.current[r]=o},className:`vitrina-card group relative flex flex-col transition-all duration-700 ${l?"mob-card-visible":"mob-card-hidden"}`,children:[t.jsx("div",{className:"vitrina-premium-contour absolute inset-[-1px] z-40 pointer-events-none transition-all duration-1000",style:{borderRadius:e(i.borderRadius),border:"1px solid #B05024",boxShadow:"0 0 15px rgba(176, 80, 36, 0.1)"}}),t.jsx("div",{className:"flex items-center justify-end local-tabs-row mb-[1.5rem] px-[0.5rem] relative z-20",children:["exterior","interior"].map(o=>t.jsxs("button",{onClick:m=>{m.preventDefault(),I(r,o)},className:`local-stealth-tab uppercase font-bold tracking-[0.2em] transition-all duration-300 relative py-[0.25rem] ${n===o?"active text-white":"text-white/20 hover:text-white/50"}`,children:[o==="exterior"?"СНАРУЖИ":"ВНУТРИ",t.jsx("span",{className:`tab-underline absolute bottom-[-6px] left-0 h-[2px] bg-[#B05024] transition-all duration-500 ${n===o?"w-full":"w-0"}`})]},o))}),t.jsxs("div",{className:"relative w-full aspect-square overflow-hidden mb-[2rem] z-10 blur-up-container",style:{borderRadius:e(i.borderRadius-8)},children:[t.jsx("div",{className:"vitrina-badge absolute top-[1.25rem] left-[1.25rem] z-30 flex items-center justify-center pointer-events-none",children:t.jsx("div",{className:"badge-content font-black uppercase whitespace-nowrap",children:c.badgeText})}),t.jsxs("div",{className:"absolute inset-0 z-0",children:[t.jsx("img",{src:a.imageExterior,alt:a.title,loading:"lazy",onLoad:()=>f(r,"exterior"),className:`absolute inset-0 w-full h-full object-cover object-center transition-all duration-1000 group-hover:scale-110 blur-up-img ${s?"is-loaded":""}`,style:{opacity:n==="exterior"&&s?1:0,zIndex:n==="exterior"?2:1}}),t.jsx("img",{src:a.imageInterior,alt:`${a.title} interior`,loading:"lazy",onLoad:()=>f(r,"interior"),className:`absolute inset-0 w-full h-full object-cover object-center transition-all duration-1000 group-hover:scale-110 blur-up-img ${g?"is-loaded":""}`,style:{opacity:n==="interior"&&g?1:0,zIndex:n==="interior"?2:1}})]}),t.jsx("div",{className:"absolute inset-0 z-10 bg-gradient-to-t from-[#0B1221]/30 to-transparent opacity-40"}),t.jsx("div",{className:"absolute inset-0 z-10 border-[1px] border-white/5 rounded-[inherit] pointer-events-none"})]}),t.jsxs("div",{className:"flex flex-col px-[0.5rem] relative z-20",children:[t.jsxs("div",{className:"flex flex-col gap-[0.75rem] mb-[2rem]",children:[t.jsx("h3",{className:"vitrina-item-title text-white font-black uppercase tracking-wider leading-tight",children:a.title}),t.jsx("span",{className:"vitrina-item-subtitle gold-gradient font-bold uppercase tracking-[0.1em] leading-snug",children:a.subtitle})]}),t.jsx("a",{href:a.href,onClick:o=>{o.preventDefault();const m=a.href.replace("#","");window.location.hash=`#katalog/${m}`,window.dispatchEvent(new CustomEvent("nordline-navigate",{detail:{page:"katalog"}}))},className:"vitrina-btn w-full flex items-center justify-center text-white font-black uppercase transition-all duration-500",children:a.buttonText})]})]},r)})}),t.jsx("style",{children:`
        :root {
          --v-gap: ${e(i.gap)};
